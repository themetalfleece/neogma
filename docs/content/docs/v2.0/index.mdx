...
Neogma v2 introduces a **decorator-based model definition** that reduces boilerplate and makes your code more readable:

- **`@Node`, `@Property`, `@Relationship` decorators** - define models with simple class decorators instead of configuration objects
...
See the [migration guide](/docs/v2.0/migration) for step-by-step instructions on upgrading from v1.
...
<Callout type="info">
  ...
  and the v1 source is on the [`v1`
  branch](https://github.com/themetalfleece/neogma/tree/v1).
</Callout>
...
- [Installation](/docs/v2.0/getting-started/installation) - install neogma and set up your project
- [Defining models](/docs/v2.0/models/decorator-based) - learn the decorator-based model API
- [Query Builder](/docs/v2.0/query-builder) - build complex Cypher queries
- [Migration from v1](/docs/v2.0/migration) - upgrade from neogma v1
