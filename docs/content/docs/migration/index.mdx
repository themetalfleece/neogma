...
### 8. Use `neogma.model()` instead of `ModelFactory`

`ModelFactory` is deprecated and will be removed in a future release. Use the decorator-based API with `neogma.model()` for all new models.
